...
public class Task7 {
    public static void main(String[] args) {
        ...
        System.out.println(getSumOfDividers(8128));
    }
    ...
    static int getFriendlyPair(int n) {
        ...
        for (int i = n - 1; i > 2; i--) {
            int sumOfDividers = getSumOfDividers(i);
            if (i != sumOfDividers && getSumOfDividers(sumOfDividers) == i) {
                return i;
            }
        }
    ...
    static int getSumOfDividers(int x) {
        int result = 1;
        int limit = x / 2;
        ...
        for (int i = 2; i < limit; i++) {
            if (x % i == 0) {
                result += i;
                int oppositeDivider = x / i;
                if (i != oppositeDivider) {
                    result += oppositeDivider;
                }
                limit = oppositeDivider;
            }
        }
